...
int main(int argc, char *argv[]) {
	...
	if (argc == 4) echoServPort = atoi(argv[3]); /* Use given port, if any */
	...
	while (totalBytesRcvd < echoStringLen) { /* Receive up to the buffer size (minus 1 to leave space for a null terminator) bytes from the sender */
